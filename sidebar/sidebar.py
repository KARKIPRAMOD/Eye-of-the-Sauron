...
from notifications import show_notifications  # Import the function
...
class SidebarApp(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.notification_1.clicked.connect(self.show_notifications)  # Adjusted to the correct button name
